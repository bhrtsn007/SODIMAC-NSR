...
Remrestart_butler () {
    ...
    then
        echo "Wrong Butler ID"
           ...
           sshpass -p 'apj0702' ssh -o StrictHostKeyChecking=no -t gor@$bot_ip "echo 'apj0702'| sudo -S service butler_remote restart"
           echo "<br>"
           echo "OK Done...."
    fi
}
...
echo '<title>Remrestart a Butler</title>'
echo '</head>'
